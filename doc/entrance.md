...
- 2: `UserMealWithExcess` и `UserMeal` это разные сущности: Transfer Object и Entity. Их делают максимально независимыми. Transfer Object мы будет их проходить на 2м уроке.
